...
var G__49121 = devtools.prefs.pref(v);
v = G__49121;
continue;
} else {
return v;
...
}catch (e49012){var _e__34544__auto__ = e49012;
return false;
}})();
...
}catch (e49019){var _e__34544__auto__ = e49019;
return false;
}})();
...
}catch (e49024){var _e__34544__auto__ = e49024;
return false;
}}
}
});
...
var vec__49058 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49058,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49058,(1),null);
...
return cljs.core.some((function (p1__49097_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__49097_SHARP_);
}),template);
});
