...
var len__4818__auto___49196 = arguments.length;
var i__4819__auto___49197 = (0);
while(true){
if((i__4819__auto___49197 < len__4818__auto___49196)){
args__4824__auto__.push((arguments[i__4819__auto___49197]));

var G__49200 = (i__4819__auto___49197 + (1));
i__4819__auto___49197 = G__49200;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq49123){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49124,G__49125,seq49123__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__49140_SHARP_){
return (!((cljs.core.meta(p1__49140_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49156__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e49158){var _e__34544__auto__ = e49158;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e49162){var _e__34544__auto__ = e49162;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__49174 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__49175 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__49175);

try{var map__49176 = opts;
var map__49176__$1 = cljs.core.__destructure_map(map__49176);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49176__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__49174);
}});
...
var temp__5751__auto___49221 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___49221)){
var managed_print_level_49222 = temp__5751__auto___49221;
var _STAR_print_level_STAR__orig_val__49189_49223 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__49190_49224 = managed_print_level_49222;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__49190_49224);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__49186_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__49186_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__49189_49223);
}} else {
job_fn();
}
