...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_51662 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_51662(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_51663 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_51663(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_51664 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_51664(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_51665 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_51665(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_51666 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_51666(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_51667 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_51667(reader);
}
});
...
var G__51676 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__51677 = s.append(c);
c = G__51676;
s = G__51677;
continue;
}
