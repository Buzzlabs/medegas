...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58522_SHARP_){
return html_coll.item(p1__58522_SHARP_);
...
return cljs.core.some((function (p1__58524_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("icon",p1__58524_SHARP_);
...
var ctx_58555 = cvs.getContext("2d");
(ctx_58555.fillStyle = color);

ctx_58555.fillRect((0),(0),size,size);
