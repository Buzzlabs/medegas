...
var G__57530 = o;
goog.object.set(G__57530,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__57534 = o;
goog.object.set(G__57534,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__57554__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__57555__i < G__57555__a.length) {G__57555__a[G__57555__i] = arguments[G__57555__i + 0]; ++G__57555__i;}
  args = new cljs.core.IndexedSeq(G__57555__a,0,null);
} 
return G__57554__delegate.call(this,args);};
G__57554.cljs$lang$maxFixedArity = 0;
G__57554.cljs$lang$applyTo = (function (arglist__57556){
var args = cljs.core.seq(arglist__57556);
return G__57554__delegate(args);
});
...
var G__57535 = props;
var G__57535__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__57535,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__57535);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__57535__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__57536 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__57536,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__57536;
}
})(),id_class);
...
var G__57537 = (cljs.core.count(argv) - first_child);
switch (G__57537) {
case (0):
...
var vec__57538 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57538,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57538,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57538,(2),null);
...
var temp__5757__auto___57563 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___57563 == null)){
} else {
var key_57564 = temp__5757__auto___57563;
(jsprops.key = key_57564);
}
...
var temp__5757__auto___57566 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___57566 == null)){
} else {
var key_57567 = temp__5757__auto___57566;
(jsprops.key = key_57567);
}
...
var temp__5757__auto___57568 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___57568 == null)){
} else {
var key_57569 = temp__5757__auto___57568;
(jsprops.key = key_57569);
}
...
var temp__5757__auto___57574 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___57574 == null)){
} else {
var key_57575 = temp__5757__auto___57574;
(jsprops.key = key_57575);
}
...
var temp__5757__auto___57576 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___57576 == null)){
} else {
var key_57577 = temp__5757__auto___57576;
(jsprops.key = key_57577);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57541_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__57541_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__57542 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57542,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57542,(1),null);
...
break;
default:
var G__57581 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__57582 = compiler;
v = G__57581;
compiler = G__57582;
continue;
...
var G__57546 = tag;
var G__57546__$1 = (((G__57546 instanceof cljs.core.Keyword))?G__57546.fqn:null);
switch (G__57546__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template57548 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template57548 = (function (opts,id,fn_to_element,parse_fn,meta57549){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template57548.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_57550,meta57549__$1){
var self__ = this;
var _57550__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template57548(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta57549__$1));
}));

(reagent.impl.template.t_reagent$impl$template57548.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_57550){
var self__ = this;
var _57550__$1 = this;
return self__.meta57549;
}));

(reagent.impl.template.t_reagent$impl$template57548.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template57548.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template57548.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template57548.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template57548.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template57548.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta57549","meta57549",-44795384,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template57548.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template57548.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template57548");

(reagent.impl.template.t_reagent$impl$template57548.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template57548");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template57548.
 */
reagent.impl.template.__GT_t_reagent$impl$template57548 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template57548(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta57549){
return (new reagent.impl.template.t_reagent$impl$template57548(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta57549));
});

}

return (new reagent.impl.template.t_reagent$impl$template57548(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
