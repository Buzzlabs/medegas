...
var node = (function (){var G__58681 = new cljs.core.Keyword(null,"style","style",-496642736);
var G__58682 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),"cljs-test-display-style"], null);
var G__58683 = style_string_58747;
return (cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3 ? cljs_test_display.core.n.cljs$core$IFn$_invoke$arity$3(G__58681,G__58682,G__58683) : cljs_test_display.core.n.call(null,G__58681,G__58682,G__58683));
})();
...
var len__4818__auto___58748 = arguments.length;
var i__4819__auto___58749 = (0);
while(true){
if((i__4819__auto___58749 < len__4818__auto___58748)){
args__4824__auto__.push((arguments[i__4819__auto___58749]));

var G__58750 = (i__4819__auto___58749 + (1));
i__4819__auto___58749 = G__58750;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs_test_display.core.n.cljs$lang$applyTo = (function (seq58684){
var G__58685 = cljs.core.first(seq58684);
var seq58684__$1 = cljs.core.next(seq58684);
var G__58686 = cljs.core.first(seq58684__$1);
var seq58684__$2 = cljs.core.next(seq58684__$1);
var self__4805__auto__ = this;
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58685,G__58686,seq58684__$2);
}));
...
var vec__58694 = ((clojure.string.starts_with_QMARK_(cljs.core.first(classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.first(classes),(1)),cljs.core.rest(classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58694,(0),null);
var classes__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58694,(1),null);
var G__58698 = cljs.core.PersistentArrayMap.EMPTY;
var G__58698__$1 = (cljs.core.truth_(id)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58698,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__58698);
if(cljs.core.truth_(cljs.core.not_empty(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__58698__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",classes__$1));
} else {
return G__58698__$1;
}
} else {
...
return (function() { 
var G__58752__delegate = function (klass,contents){
var vec__58699 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons(klass,contents)], null));
var klass__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58699,(0),null);
var contents__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58699,(1),null);
...
var G__58752 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__58753__i = 0, G__58753__a = new Array(arguments.length -  1);
while (G__58753__i < G__58753__a.length) {G__58753__a[G__58753__i] = arguments[G__58753__i + 1]; ++G__58753__i;}
  contents = new cljs.core.IndexedSeq(G__58753__a,0,null);
} 
return G__58752__delegate.call(this,klass,contents);};
G__58752.cljs$lang$maxFixedArity = 1;
G__58752.cljs$lang$applyTo = (function (arglist__58754){
var klass = cljs.core.first(arglist__58754);
var contents = cljs.core.rest(arglist__58754);
return G__58752__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__58706){
var map__58707 = p__58706;
var map__58707__$1 = cljs.core.__destructure_map(map__58707);
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58707__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58707__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__58711){
var map__58712 = p__58711;
var map__58712__$1 = cljs.core.__destructure_map(map__58712);
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58712__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58712__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__58715){
var map__58717 = p__58715;
var map__58717__$1 = cljs.core.__destructure_map(map__58717);
var expected = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58717__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58717__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__58724_SHARP_){
return cljs.core.cons(new_current_node,p1__58724_SHARP_);
}));
...
var curr_node = cljs_test_display.core.current_node();
var map__58726 = cljs_test_display.core.current_var_info();
var map__58726__$1 = cljs.core.__destructure_map(map__58726);
var info = map__58726__$1;
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58726__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58726__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58726__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),(function (p1__58725_SHARP_){
return cljs.core.cons(node,p1__58725_SHARP_);
}));

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__58728){
var map__58729 = p__58728;
var map__58729__$1 = cljs.core.__destructure_map(map__58729);
var m = map__58729__$1;
var fail = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58729__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58729__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58729__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58729__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__58731 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__58731) : formatter_fn.call(null,G__58731));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__58732 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__58732) : formatter_fn.call(null,G__58732));
})()], 0));
});
...
var temp__5753__auto___58759 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5753__auto___58759)){
var message_58760 = temp__5753__auto___58759;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_58760], 0));
} else {
}
...
var temp__5753__auto___58761 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5753__auto___58761)){
var message_58762 = temp__5753__auto___58761;
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([message_58762], 0));
} else {
}
