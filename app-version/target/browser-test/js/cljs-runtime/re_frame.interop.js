...
return [(function (){var pred__57697 = cljs.core.instance_QMARK_;
var expr__57698 = reactive_val;
if(cljs.core.truth_((pred__57697.cljs$core$IFn$_invoke$arity$2 ? pred__57697.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__57698) : pred__57697.call(null,reagent.ratom.RAtom,expr__57698)))){
return "ra";
} else {
if(cljs.core.truth_((pred__57697.cljs$core$IFn$_invoke$arity$2 ? pred__57697.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__57698) : pred__57697.call(null,reagent.ratom.RCursor,expr__57698)))){
return "rc";
} else {
if(cljs.core.truth_((pred__57697.cljs$core$IFn$_invoke$arity$2 ? pred__57697.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__57698) : pred__57697.call(null,reagent.ratom.Reaction,expr__57698)))){
return "rx";
} else {
if(cljs.core.truth_((pred__57697.cljs$core$IFn$_invoke$arity$2 ? pred__57697.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__57698) : pred__57697.call(null,reagent.ratom.Track,expr__57698)))){
return "tr";
} else {
return "other";
}
