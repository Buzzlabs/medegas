...
* [`src/botijao/`](src/botijao/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/botijao/core.cljs): contains the SPA entry point, `init`
* [`test/botijao/`](test/botijao/): test files (ClojureScript,
...
5. Clone this repo and open a terminal in the `botijao` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/botijao/config.cljs) defaults to `true` in
...
```clj
(ns botijao.example
  (:require [botijao.config :as config])
