...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_38008 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_38008(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_38009 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_38009(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_38010 = (function (reader,ch){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_38010(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_38011 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_38011(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_38012 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_38012(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_38013 = (function (reader){
var x__4509__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_38013(reader);
}
});
...
var G__38025 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__38026 = s.append(c);
c = G__38025;
s = G__38026;
continue;
}
