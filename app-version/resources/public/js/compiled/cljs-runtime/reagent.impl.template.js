...
var G__45291 = o;
goog.object.set(G__45291,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__45292 = o;
goog.object.set(G__45292,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__45295 = props;
var G__45295__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45295,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__45295);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45295__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__45297 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45297,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__45297;
}
})(),id_class);
...
var G__45300 = (cljs.core.count(argv) - first_child);
switch (G__45300) {
case (0):
...
var vec__45302 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45302,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45302,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45302,(2),null);
...
var temp__5757__auto___45335 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___45335 == null)){
} else {
var key_45336 = temp__5757__auto___45335;
(jsprops.key = key_45336);
}
...
var temp__5757__auto___45342 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___45342 == null)){
} else {
var key_45343 = temp__5757__auto___45342;
(jsprops.key = key_45343);
}
...
var temp__5757__auto___45347 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___45347 == null)){
} else {
var key_45348 = temp__5757__auto___45347;
(jsprops.key = key_45348);
}
...
var temp__5757__auto___45352 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___45352 == null)){
} else {
var key_45353 = temp__5757__auto___45352;
(jsprops.key = key_45353);
}
...
var temp__5757__auto___45354 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___45354 == null)){
} else {
var key_45355 = temp__5757__auto___45354;
(jsprops.key = key_45355);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45314_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__45314_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__45315 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45315,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45315,(1),null);
...
break;
default:
var G__45364 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__45365 = compiler;
v = G__45364;
compiler = G__45365;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template45321 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template45321 = (function (opts,id,fn_to_element,parse_fn,meta45322){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template45321.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_45323,meta45322__$1){
var self__ = this;
var _45323__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template45321(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta45322__$1));
}));

(reagent.impl.template.t_reagent$impl$template45321.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_45323){
var self__ = this;
var _45323__$1 = this;
return self__.meta45322;
}));

(reagent.impl.template.t_reagent$impl$template45321.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template45321.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template45321.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template45321.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template45321.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template45321.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta45322","meta45322",1406522519,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template45321.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template45321.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template45321");

(reagent.impl.template.t_reagent$impl$template45321.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template45321");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template45321.
 */
reagent.impl.template.__GT_t_reagent$impl$template45321 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template45321(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta45322){
return (new reagent.impl.template.t_reagent$impl$template45321(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta45322));
});

}

return (new reagent.impl.template.t_reagent$impl$template45321(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
