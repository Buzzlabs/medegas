...
var G__31980 = cljs.core.first(element_str);
switch (G__31980) {
case "?":
arr.push((1));
...
var G__31989 = cljs.core.next(items);
items = G__31989;
continue;
} else {
return null;
...
var G__31990 = cljs.core.next(items);
items = G__31990;
continue;
} else {
return null;
...
while(true){
if(items){
if(cljs.core.truth_((function (){var G__31983 = cljs.core.first(items);
return (is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1 ? is_valid_QMARK_.cljs$core$IFn$_invoke$arity$1(G__31983) : is_valid_QMARK_.call(null,G__31983));
})())){
var G__31992 = cljs.core.next(cljs.core.next(items));
items = G__31992;
continue;
} else {
return true;
...
switch (G__31986) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__31984_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__31984_SHARP_,(2));
})))){
...
break;
case (1):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_(path,(function (p1__31985_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__31985_SHARP_,(1));
})))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__31986)].join('')));
