...
var map__35277 = top_item;
var map__35277__$1 = cljs.core.__destructure_map(map__35277);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35277__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35277__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35277__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e35276){var _e = e35276;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___35365 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5751__auto___35365)){
var seen_errors_35366 = temp__5751__auto___35365;
if(cljs.core.truth_(seen_errors_35366.has(self))){
} else {
seen_errors_35366.add(self);

var temp__5753__auto___35367 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5753__auto___35367)){
var sense_35368 = temp__5753__auto___35367;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_35368)].join(''));
} else {
}
}
} else {
