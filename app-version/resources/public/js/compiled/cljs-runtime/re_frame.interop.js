...
return [(function (){var pred__45484 = cljs.core.instance_QMARK_;
var expr__45485 = reactive_val;
if(cljs.core.truth_((pred__45484.cljs$core$IFn$_invoke$arity$2 ? pred__45484.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__45485) : pred__45484.call(null,reagent.ratom.RAtom,expr__45485)))){
return "ra";
} else {
if(cljs.core.truth_((pred__45484.cljs$core$IFn$_invoke$arity$2 ? pred__45484.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__45485) : pred__45484.call(null,reagent.ratom.RCursor,expr__45485)))){
return "rc";
} else {
if(cljs.core.truth_((pred__45484.cljs$core$IFn$_invoke$arity$2 ? pred__45484.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__45485) : pred__45484.call(null,reagent.ratom.Reaction,expr__45485)))){
return "rx";
} else {
if(cljs.core.truth_((pred__45484.cljs$core$IFn$_invoke$arity$2 ? pred__45484.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__45485) : pred__45484.call(null,reagent.ratom.Track,expr__45485)))){
return "tr";
} else {
return "other";
}
