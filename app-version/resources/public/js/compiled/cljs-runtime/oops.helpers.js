...
var G__31776 = cljs.core.next(items);
items = G__31776;
continue;
} else {
return arr;
...
var x31714 = error;
(x31714.cljs$core$IPrintWithWriter$ = cljs.core.PROTOCOL_SENTINEL);

(x31714.cljs$core$IPrintWithWriter$_pr_writer$arity$3 = (function (_obj,writer,opts){
var _obj__$1 = this;
...
var G__31778 = Object.getPrototypeOf(o);
o = G__31778;
continue;
} else {
