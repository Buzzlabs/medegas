...
var len__4818__auto___35737 = arguments.length;
var i__4819__auto___35738 = (0);
while(true){
if((i__4819__auto___35738 < len__4818__auto___35737)){
args__4824__auto__.push((arguments[i__4819__auto___35738]));

var G__35741 = (i__4819__auto___35738 + (1));
i__4819__auto___35738 = G__35741;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq35627){
...
return self__4805__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35628,G__35629,seq35627__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__35650_SHARP_){
return (!((cljs.core.meta(p1__35650_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35681__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e35683){var _e__34544__auto__ = e35683;
return false;
}})();
if(cljs.core.truth_(or__4212__auto__)){
return or__4212__auto__;
...
}catch (e35689){var _e__34544__auto__ = e35689;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__35703 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__35704 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__35704);

try{var map__35707 = opts;
var map__35707__$1 = cljs.core.__destructure_map(map__35707);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35707__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__35703);
}});
...
var temp__5751__auto___35772 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___35772)){
var managed_print_level_35773 = temp__5751__auto___35772;
var _STAR_print_level_STAR__orig_val__35718_35774 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__35719_35775 = managed_print_level_35773;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__35719_35775);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__35714_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__35714_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__35718_35774);
}} else {
job_fn();
}
